...
if (!MMe) { 
  if(file.exists("sinfu1_md.csv")){
      ...
      par<-check.para(par)
      write.csv(par,file="sinfu1_md.csv",row.names=FALSE)
      cat("\n")       
  ...
  if(file.exists("sinfu1_mm_md.csv")){
    ...
    par<-check.para(par)
    write.csv(par,file="sinfu1_mm_md.csv",row.names=FALSE)
    cat("\n")       
    print(par, row.names=F)
...
if (!MMe) { 
  if(file.exists("sinfu1.csv")){
      ...
      par<-check.para(par)
      write.csv(par,file="sinfu1.csv",row.names=FALSE)
      cat("\n")       
      print(par, row.names=F)
  ...
  if(file.exists("sinfu1_mm.csv")){
    ...
    par<-check.para(par)
    write.csv(par,file="sinfu1_mm.csv",row.names=FALSE)
    cat("\n")       
    print(par, row.names=F)
